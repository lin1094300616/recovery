package com.example.recovery.framework.interceptor;//package com.examp.travel.framework.interceptor;

import com.alibaba.fastjson.JSONObject;
import com.example.recovery.framework.configurer.Permission;
import com.example.recovery.framework.entity.Response;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws IOException {
        ...
        if (user == null) {
            ...
            Map res = ResponseMap.factoryResult(StatusEnum.SYSTEM_ERROR_9001.getCode(), StatusEnum.SYSTEM_ERROR_9001.getData());
