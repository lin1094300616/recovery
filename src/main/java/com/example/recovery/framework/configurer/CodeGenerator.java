...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/recovery?characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSL=false");
        ...
        pc.setParent("com.example.recovery.system");
